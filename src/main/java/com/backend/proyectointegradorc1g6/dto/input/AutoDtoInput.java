...
public class AutoDtoInput {
    ...
    @Size(max = 25, message = "The value matricula should has max 25 characters")
    ...
    @Size(max = 25, message = "The value marca should has max 25 characters")
    ...
    @Size(max = 25, message = "The value potenciaHP should has max 25 characters")
    private String potenciaHP;
    @NotBlank(message = "The value velocidad should not be empty")
    @Size(max = 25, message = "The value velocidad should has max 25 characters")
    private String velocidad;
    @NotBlank(message = "The value aceleracion should not be empty")
    @Size(max = 25, message = "The value aceleracion should has max 25 characters")
    ...
    @Size(max = 25, message = "The value FechaFabricacion should has max 25 characters")
    private String fechaFabricacion;
    private boolean estaActivo;
    @NotNull(message = "The value categorias should not be empty")
    @Valid
    private List<CategoriaDtoInput> categorias;

    @NotNull(message = "The value categorias should not be empty")
    @Valid
    private List<CaracteristicaDtoInput> caracteristicas;
