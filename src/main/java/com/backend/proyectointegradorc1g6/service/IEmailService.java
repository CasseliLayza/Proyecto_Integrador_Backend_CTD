...
public interface IEmailService {
    ...
    Map<String, String> sendEmailCustomerReservation(String[] toUser, String subject, String message, String name, String logo, EmailReservDto details) throws FailedSendMailMessageException;
